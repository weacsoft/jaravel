...
@section('content')
    <h2 style="margin-bottom:16px;">📝 任务列表（CRUD + 精准刷新）</h2>
    <p class="hint" style="margin-bottom:20px;">
        基于 SQLite 真实数据库。增删改操作后只刷新列表区域，输入框状态保留（data-wire-key 最小化 diff）。
    </p>
    ...
    <div class="card">
        ...
        <table>
            ...
            <tbody wire:section="list">
                ...
                @empty
                <tr>
                    <td colspan="4" style="text-align:center; padding:24px; color:#888;">暂无任务，添加一个吧</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="card">
        ...
        <ul style="line-height:2; padding-left:20px;">
            <li><code>data-wire-key</code> 标记 DOM 元素，刷新后保留输入框状态</li>
            <li><code>wire:section="list"</code> 标记列表区域，精准刷新只更新这部分</li>
            <li>控制器代码完全无 Wire 耦合——只需正常使用 <code>ResponseBuilder.view()</code></li>
        </ul>
    </div>
@endsection
